using RSV_dashboard.Bot.Models;
using Microsoft.ML;
using System;
...
namespace RSV_dashboard.Bot.Services
{
    /// <summary>
    ...
    public class AIService
    {
        ...
        public static string SaveModelFile(MLContext mlContext, ITransformer mlModel, DataViewSchema modelInputSchema)
        {
           ...
           var modelPath = $"Bot\\TestingBots\\Models\\{Guid.NewGuid()}.zip";

           //temp override so as not to keep creating files
            modelPath = $"Bot\\TestingBots\\Models\\sample.zip";
